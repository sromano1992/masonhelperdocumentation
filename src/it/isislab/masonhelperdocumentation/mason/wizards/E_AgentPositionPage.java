...
public class E_AgentPositionPage extends WizardPage{	
	...
	public IWizardPage getNextPage(){ 
		...
		for (int i=0; i<positions.size(); i++){
			...
			ODD.addVariableToEntity(agentAnalizer.getClassName(), new Variable(positions.get(i).getVariableName(), backupUserComment, autoGeneratedComment, positions.get(i).getInitializer()));
