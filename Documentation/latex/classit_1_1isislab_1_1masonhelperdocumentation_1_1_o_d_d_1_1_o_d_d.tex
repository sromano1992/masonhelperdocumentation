...
Add entity e in entite\-\_\-s collection. First there is a control to check if \hyperlink{classit_1_1isislab_1_1masonhelperdocumentation_1_1_o_d_d_1_1_entity}{Entity} is already in collection. This has sense because also at first run of program some entities could be get from \hyperlink{classit_1_1isislab_1_1masonhelperdocumentation_1_1_o_d_d_1_1_o_d_d}{O\-D\-D} serialized files. 
...
\begin{DoxyCode}
141                                           \{
142         \textcolor{keywordtype}{boolean} alreadyIn = \textcolor{keyword}{false};
143         ArrayList<Entity> \hyperlink{classit_1_1isislab_1_1masonhelperdocumentation_1_1_o_d_d_1_1_o_d_d_a83f519302af9e043ba9504d5da426410}{entitie\_s} = \hyperlink{classit_1_1isislab_1_1masonhelperdocumentation_1_1_o_d_d_1_1_o_d_d_a42a9a6f8615c70c73034e5c23dd8eb0f}{getEntitie\_s}().getEntitie\_s();
144         \textcolor{keywordflow}{for} (Entity entity : entitie\_s)\{
145             \textcolor{keywordflow}{if} (entity.getName().equals(e.getName()))\{
146                 entity.setDescription(e.getDescription());
147                 alreadyIn = \textcolor{keyword}{true};
148             \}
149         \}
150         \textcolor{keywordflow}{if} (!alreadyIn)
151             \hyperlink{classit_1_1isislab_1_1masonhelperdocumentation_1_1_o_d_d_1_1_o_d_d_a42a9a6f8615c70c73034e5c23dd8eb0f}{getEntitie\_s}().add(e);
152     \}
\end{DoxyCode}
...
\begin{DoxyCode}
164                                                                                                   \{
165         \hyperlink{classit_1_1isislab_1_1masonhelperdocumentation_1_1_o_d_d_1_1_o_d_d_a4d34153928ab00d1226f5634997ac74a}{getProcessOverviewAndScheduling}().addProcessOverviewElement(who, 
...
\begin{DoxyCode}
168                                               \{
169         \hyperlink{classit_1_1isislab_1_1masonhelperdocumentation_1_1_o_d_d_1_1_o_d_d_aef8c41e667fde06c42bf1e06f95bd180}{getSubmodel\_s}().addSubmodel(s);
170     \}
\end{DoxyCode}
...
\begin{DoxyCode}
158                                                                          \{
159         \textcolor{keywordflow}{if} (\hyperlink{classit_1_1isislab_1_1masonhelperdocumentation_1_1_o_d_d_1_1_o_d_d_a0ae0e44cbaa43b0c0b3ca99cc1d93c92}{getEntity}(entityName) == null)
160             \hyperlink{classit_1_1isislab_1_1masonhelperdocumentation_1_1_o_d_d_1_1_o_d_d_a4575fcc3769dbc8a38f58ac19f8d13a9}{addEntity}(\textcolor{keyword}{new} Entity(entityName, \textcolor{stringliteral}{""}));
161         \hyperlink{classit_1_1isislab_1_1masonhelperdocumentation_1_1_o_d_d_1_1_o_d_d_a0ae0e44cbaa43b0c0b3ca99cc1d93c92}{getEntity}(entityName).addVariable(v);      
162     \}
\end{DoxyCode}
...
242                                                                                                            
                     \{
243         FileInputStream fis = \textcolor{keyword}{new} FileInputStream(ConfigFile.gettODDPath() + objName);
244         ObjectInputStream ois = \textcolor{keyword}{new} ObjectInputStream(fis);
245         Object toReturn = ois.readObject();
246         ois.close();
247         log .info(\textcolor{stringliteral}{"Deserialized: "} + objName);
248         \textcolor{keywordflow}{return} toReturn;
249     \}
\end{DoxyCode}
...
\begin{DoxyCode}
94                                                     \{
95         \textcolor{keywordflow}{if} (\hyperlink{classit_1_1isislab_1_1masonhelperdocumentation_1_1_o_d_d_1_1_o_d_d_a6be57819872ca078db4b2791ef8ddc8f}{designConcepts} == null)
96             \hyperlink{classit_1_1isislab_1_1masonhelperdocumentation_1_1_o_d_d_1_1_o_d_d_a6be57819872ca078db4b2791ef8ddc8f}{designConcepts} = \textcolor{keyword}{new} DesignConcepts();
97         \textcolor{keywordflow}{return} \hyperlink{classit_1_1isislab_1_1masonhelperdocumentation_1_1_o_d_d_1_1_o_d_d_a6be57819872ca078db4b2791ef8ddc8f}{designConcepts};
98     \}
\end{DoxyCode}
...
\begin{DoxyCode}
47                                           \{
48         \textcolor{keywordflow}{if} (\hyperlink{classit_1_1isislab_1_1masonhelperdocumentation_1_1_o_d_d_1_1_o_d_d_a83f519302af9e043ba9504d5da426410}{entitie\_s} == null)
49             \hyperlink{classit_1_1isislab_1_1masonhelperdocumentation_1_1_o_d_d_1_1_o_d_d_a83f519302af9e043ba9504d5da426410}{entitie\_s} = \textcolor{keyword}{new} Entitie\_s();
50         \textcolor{keywordflow}{return} \hyperlink{classit_1_1isislab_1_1masonhelperdocumentation_1_1_o_d_d_1_1_o_d_d_a83f519302af9e043ba9504d5da426410}{entitie\_s};
51     \}
\end{DoxyCode}
...
\begin{DoxyCode}
154                                                \{
155         \textcolor{keywordflow}{return} \hyperlink{classit_1_1isislab_1_1masonhelperdocumentation_1_1_o_d_d_1_1_o_d_d_a42a9a6f8615c70c73034e5c23dd8eb0f}{getEntitie\_s}().getEntity(name);
156     \}
\end{DoxyCode}
...
\begin{DoxyCode}
100                                                     \{
101         \textcolor{keywordflow}{if} (\hyperlink{classit_1_1isislab_1_1masonhelperdocumentation_1_1_o_d_d_1_1_o_d_d_a450d24dd94f21b39d4015e570cda5fb2}{initialization} == null)
102             \hyperlink{classit_1_1isislab_1_1masonhelperdocumentation_1_1_o_d_d_1_1_o_d_d_a450d24dd94f21b39d4015e570cda5fb2}{initialization} = \textcolor{keyword}{new} Initialization();
103         \textcolor{keywordflow}{return} \hyperlink{classit_1_1isislab_1_1masonhelperdocumentation_1_1_o_d_d_1_1_o_d_d_a450d24dd94f21b39d4015e570cda5fb2}{initialization};
104     \}
\end{DoxyCode}
...
\begin{DoxyCode}
53                                                                                 \{
54         \textcolor{keywordflow}{if} (\hyperlink{classit_1_1isislab_1_1masonhelperdocumentation_1_1_o_d_d_1_1_o_d_d_a85593fdcad9dba6fb7145ee6759e0a3e}{process} == null)
55             \hyperlink{classit_1_1isislab_1_1masonhelperdocumentation_1_1_o_d_d_1_1_o_d_d_a85593fdcad9dba6fb7145ee6759e0a3e}{process} = \textcolor{keyword}{new} ProcessOverviewAndScheduling();
56         \textcolor{keywordflow}{return}  \hyperlink{classit_1_1isislab_1_1masonhelperdocumentation_1_1_o_d_d_1_1_o_d_d_a85593fdcad9dba6fb7145ee6759e0a3e}{process};
57     \}
\end{DoxyCode}
...
\begin{DoxyCode}
41                                       \{
42         \textcolor{keywordflow}{if} (\hyperlink{classit_1_1isislab_1_1masonhelperdocumentation_1_1_o_d_d_1_1_o_d_d_a81602d5a0bf0650c69808c4188b4319e}{purpose} == null)
43             \hyperlink{classit_1_1isislab_1_1masonhelperdocumentation_1_1_o_d_d_1_1_o_d_d_a81602d5a0bf0650c69808c4188b4319e}{purpose} = \textcolor{keyword}{new} Purpose();
44         \textcolor{keywordflow}{return} \hyperlink{classit_1_1isislab_1_1masonhelperdocumentation_1_1_o_d_d_1_1_o_d_d_a81602d5a0bf0650c69808c4188b4319e}{purpose};
45     \}
\end{DoxyCode}
...
\begin{DoxyCode}
59                                             \{
60         \textcolor{keywordflow}{if} (\hyperlink{classit_1_1isislab_1_1masonhelperdocumentation_1_1_o_d_d_1_1_o_d_d_a1da5e6dcf76e4a83ec91831f5ab98bf2}{submodel\_s} == null)
61             \hyperlink{classit_1_1isislab_1_1masonhelperdocumentation_1_1_o_d_d_1_1_o_d_d_a1da5e6dcf76e4a83ec91831f5ab98bf2}{submodel\_s} = \textcolor{keyword}{new} Submodel\_s();
62         \textcolor{keywordflow}{return} \hyperlink{classit_1_1isislab_1_1masonhelperdocumentation_1_1_o_d_d_1_1_o_d_d_a967fd254c4e555432b7dba443855922e}{clearSubmodel\_s}();
63     \}
\end{DoxyCode}
...
178             \hyperlink{classit_1_1isislab_1_1masonhelperdocumentation_1_1_o_d_d_1_1_o_d_d_a75c591cb9280595f4f3a3201dea04645}{serializeObj}(Purpose.serializedName, \hyperlink{classit_1_1isislab_1_1masonhelperdocumentation_1_1_o_d_d_1_1_o_d_d_aa537a775bb22e03b1a0b1a407a4fbd06}{getPurpose}());
179             \hyperlink{classit_1_1isislab_1_1masonhelperdocumentation_1_1_o_d_d_1_1_o_d_d_a75c591cb9280595f4f3a3201dea04645}{serializeObj}(Entitie\_s.serializedName, \hyperlink{classit_1_1isislab_1_1masonhelperdocumentation_1_1_o_d_d_1_1_o_d_d_a42a9a6f8615c70c73034e5c23dd8eb0f}{getEntitie\_s}());
180             \hyperlink{classit_1_1isislab_1_1masonhelperdocumentation_1_1_o_d_d_1_1_o_d_d_a75c591cb9280595f4f3a3201dea04645}{serializeObj}(ProcessOverviewAndScheduling.serializedName, 
...
181             \textcolor{comment}{//serializeObj(Submodel\_s.serializedName, getSubmodel\_s());}
182             \hyperlink{classit_1_1isislab_1_1masonhelperdocumentation_1_1_o_d_d_1_1_o_d_d_a75c591cb9280595f4f3a3201dea04645}{serializeObj}(DesignConcepts.serializedName, 
...
183             \hyperlink{classit_1_1isislab_1_1masonhelperdocumentation_1_1_o_d_d_1_1_o_d_d_a75c591cb9280595f4f3a3201dea04645}{serializeObj}(Initialization.serializedName, 
...
184             \hyperlink{classit_1_1isislab_1_1masonhelperdocumentation_1_1_o_d_d_1_1_o_d_d_a75c591cb9280595f4f3a3201dea04645}{serializeObj}(\textcolor{stringliteral}{"inputData.ser"}, \hyperlink{classit_1_1isislab_1_1masonhelperdocumentation_1_1_o_d_d_1_1_o_d_d_a003e2cc245212d81de91896a8ce4f440}{inputData});
185             log.info(\textcolor{stringliteral}{"ODD object Serialized"});
186         \} \textcolor{keywordflow}{catch} (IOException e) \{
187             log.severe(\textcolor{stringliteral}{"Error serializing ODD objects: "} + e.getMessage());
...
223                                                                                                            
              \{
224         String serializedObjPath = ConfigFile.gettODDPath() + objName;
225         Files.deleteIfExists(Paths.get(serializedObjPath));
226         FileOutputStream fileOut = \textcolor{keyword}{new} FileOutputStream(serializedObjPath);
227         ObjectOutputStream out = \textcolor{keyword}{new} ObjectOutputStream(fileOut);
228         out.writeObject(toSerialize);
229         out.close();
230         fileOut.close();
231         log.info(\textcolor{stringliteral}{"Serialized: "} + objName);
232     \}
\end{DoxyCode}
...
\begin{DoxyCode}
122                                                                         \{
123         ODD.designConcepts = \hyperlink{classit_1_1isislab_1_1masonhelperdocumentation_1_1_o_d_d_1_1_o_d_d_a6be57819872ca078db4b2791ef8ddc8f}{designConcepts};
124     \}
\end{DoxyCode}
...
\begin{DoxyCode}
110                                                          \{
111         ODD.entitie\_s = \hyperlink{classit_1_1isislab_1_1masonhelperdocumentation_1_1_o_d_d_1_1_o_d_d_a83f519302af9e043ba9504d5da426410}{entitie\_s};
112     \}
\end{DoxyCode}
...
\begin{DoxyCode}
126                                                                         \{
127         ODD.initialization = \hyperlink{classit_1_1isislab_1_1masonhelperdocumentation_1_1_o_d_d_1_1_o_d_d_a450d24dd94f21b39d4015e570cda5fb2}{initialization};
128     \}
\end{DoxyCode}
...
\begin{DoxyCode}
130                                                       \{
131         ODD.inputData = \hyperlink{classit_1_1isislab_1_1masonhelperdocumentation_1_1_o_d_d_1_1_o_d_d_a003e2cc245212d81de91896a8ce4f440}{inputData};
132     \}
\end{DoxyCode}
...
\begin{DoxyCode}
114                                                                         \{
115         ODD.process = \hyperlink{classit_1_1isislab_1_1masonhelperdocumentation_1_1_o_d_d_1_1_o_d_d_a85593fdcad9dba6fb7145ee6759e0a3e}{process};
116     \}
\end{DoxyCode}
...
\begin{DoxyCode}
106                                                    \{
107         ODD.purpose = \hyperlink{classit_1_1isislab_1_1masonhelperdocumentation_1_1_o_d_d_1_1_o_d_d_a81602d5a0bf0650c69808c4188b4319e}{purpose};
108     \}
\end{DoxyCode}
